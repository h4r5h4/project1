...
$sql="INSERT INTO faculty (`name`, `facid`, `exp`,  `branch`,  `fname`, `desig`, `dob`, `gender`, `address`, `mobile`)
VALUES
('$_POST[name]','$_POST[facid]','$_POST[exp]','$_POST[branch]','$_POST[fname]','$_POST[desig]','$_POST[dob]','$_POST[radio1]','$_POST[address]','$_POST[mphone]')";
