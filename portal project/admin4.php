...
$sql="CREATE TABLE IF NOT EXISTS `attendance` (
  ...
  `whours` int(10) NOT NULL,
  `ahours` int(10) NOT NULL,
  `perc` int(10) NOT NULL
...
$perc = ($_POST['ahours'])/($_POST['whours'])*100;
echo $perc;
$sql="INSERT INTO attendance (`rollno`, `ahours`, `whours`, `perc`)
VALUES
('$_POST[rollno]','$_POST[ahours]','$_POST[whours]','$perc')";
