                        ...
                        <div class="contentBlock">
                            <div class="login_PortalBox">
                                <div class="rhSectionBlock" style="padding: 15px; width: auto;">
                                    ...
                                    <h2 style="margin-bottom: 10px;color:#059BB6;font-size:12px;  font-weight:bold;  margin:0;  padding:0;">Log In</h2>
                                    <div class="keyline_2" style="margin: 8px -10px;">.</div>
                                                ...
                                                <!-- Customisation add onload and hidden statement to form below -->
...
<input type='hidden' name='submitted' id='submitted' value='1'/>
                                       ...
                                       <input type='submit' name='Submit' value='Log In' />
                                            ...
                                            <div class="rl">
                                                <ul><li><span class="rl"><a href="reset-pwd-req.php">Forgot your password?</a></span></li>
                                                </ul>
                                            </div>
