...
$fid = $fgmembersite->getFacultyId($_POST['email']);
$sid = $fgmembersite->getrollnum();
$semail = $fgmembersite->UserEmail();
$sname = $fgmembersite->UserFullName();
...
$sql="INSERT INTO queries (`postedto`, `postedby`, `query`)
VALUES
('$fid','$sid','$_POST[query]')";
